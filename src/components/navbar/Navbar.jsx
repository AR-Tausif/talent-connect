        ...
        <>
            <div className="bg-gray-200 h-full w-full">
                ...
                <nav className="bg-white shadow xl:block hidden">
                    <div className="mx-auto max-w-screen-xl px-6 py-2 xl:py-0">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex w-full sm:w-auto items-center sm:items-stretch justify-end sm:justify-start">
                                <div className="flex items-center">
                                    ...
                                    <h2 className="hidden sm:block text-base text-gray-700 font-bold leading-normal pl-3">Talent Connect</h2>
                                </div>
                            </div>
                            <div className="flex">
                                <NavLinksLg />
                                {
                                    user ? <AvailableUserNavLinks /> : <UnAvailableUserNavlinks />
                                }
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-base md:text-2xl text-gray-800 ml-3">Talent Connect</p>
                                                </div>
...
const UnAvailableUserNavlinks = () => {
    return (
        <div className="relative md:mr-6 my-2 space-x-5">
            ...
            <NavLink to="/register">
                <button className="focus:outline-none bg-purple-700 border-gray-300 border transition duration-150 ease-in-out hover:bg-purple-800 rounded text-white px-5 py-2 text-xs">Register</button>
            </NavLink>
        </div>
    )
}
